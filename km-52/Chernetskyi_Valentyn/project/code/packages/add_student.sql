...
CREATE OR REPLACE PACKAGE BODY STUDENT_PACKAGE IS 
    ...
    BEGIN 
    UPDATE STUDENT  
    SET STUDENT.STUDENT_FIRST_NAME = ST_FIRST_NAME 
    WHERE STUDENT.STUDENT_LAST_NAME = ST_LAST_NAME; 
    COMMIT; 
    ...
    BEGIN
    DELETE FROM STUDENT
    WHERE STUDENT.STUDENT_LAST_NAME  = ST_LAST_NAME and  STUDENT.STUDENT_FIRST_NAME  = ST_FIRST_NAME;
    COMMIT;
    END DELETE_STUDENT;
...
SELECT * FROM TABLE(STUDENT_PACKAGE.DELETE_STUDENT('valik', 'JKHJKHKJH'));
